...
# for ours_dir in results/phototourism/surf_guided_lm_buffer_radius_cache_e2_normal_4cm-20220105_160922_iter_170000; do

for iter in 270000; do
    ours_dir=results/phototourism/surf_guided_lm_buffer_radius_cache_e2_normal_4cm-20220105_160922_iter_${iter}
    echo $filename
