...
if [ scene_name -eq 'brandenburg_gate' ]; do
...
if [ scene_name -eq 'lincoln_memorial' ]; do
...
if [ scene_name -eq 'palacio_de_bellas_artes' ]; do
...
for ours_dir in results/phototourism/bg_surf_depth_20percent_1e-1-20220115_190001_iter_400000; do
    # echo ${ours_dir}
    ...
    # bg_surf_depth_20percent_1e-1-20220115_190001_iter_580000
    # bg_surf_depth_20percent_1e-1-20220115_190001_iter_90000
    pred_path=${ours_dir}/mesh
    ours_mesh_name="reprojected.ply"

    # ${scene_abv}_poisson_mesher_depth_11.ply reprojected
    # colmap_path=${WORK_SPACE}/colmap_results/${scene_abv}
    colmap_path=${WORK_SPACE}/colmap_masked/${scene_abv}
    colmap_origin=brandenburg_gate_poisson_mesher_depth_13.ply
    colmap_mesh_name=reprojected_d13.ply
    ...
    # # filtering colmap
    # python utils/reproj_filter.py \
    #   --src_file ${colmap_path}/${colmap_origin} \
    #   --target_file ${colmap_path}/${colmap_origin} \
    #   --data_path ${IMC_DATA_PATH}/phototourism/training_set/${scene_name} \
